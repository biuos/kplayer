...
KT_IMPLEMENT_EXCEPTION(LogicException,       Exception,      "Logic exception")
KT_IMPLEMENT_EXCEPTION(NullPointerException, LogicException, "Null pointer")

KT_IMPLEMENT_EXCEPTION(RuntimeException,     Exception,        "Runtime exception")
KT_IMPLEMENT_EXCEPTION(TimeoutException,     RuntimeException, "Timeout")
KT_IMPLEMENT_EXCEPTION(SystemException,      RuntimeException, "System exception")
